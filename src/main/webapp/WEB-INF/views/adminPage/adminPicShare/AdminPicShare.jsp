...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-7">
				<img src="${staticUrl}/picShare/${read.board_id}/${read.file_name}"
					class="w-100 p-3" alt="...">
			</div>
				...
				<form role="form"
					...
					<div class="input-group mb-1">
						...
						<input type="text" class="form-control" placeholder="그림제목"
							...
							readonly="readonly" value="${read.title}">
					</div>
					<div class="input-group mb-1">
						<div class="input-group-prepend">
		...
		<c:forEach items="${list}" var="list">
			<div class="col-sm-6 col-md-3">
				<div class="grid-image">
					<img src="${staticUrl}/picShare/${list.board_id}/${list.file_name}"
						class="img-thumbnail" alt="${list.file_name }"
						onclick="location.search ='?id=${list.board_id}'">
				</div>
			</div>
		</c:forEach>
	</div>
	...
	<nav aria-label="Page navigation">
		<ul class="pagination p1 justify-content-center">
			...
			<c:forEach begin="${picPageInfo.leftPageNumber }"
				end="${picPageInfo.rightPageNumber }" var="pageNumber">
				<c:url value="/adminPage/adminPicShare/AdminPicShare" var="pageLink">
					<c:param name="page" value="${pageNumber }" />
					<c:param name="keyword" value="${param.keyword}" />
				</c:url>
				<li class="page-item"><a
					class="${picPageInfo.currentPage == pageNumber ? 'is-active' : 'active' }"

				...
				<div class="board-view">
					<form id="modifyForm" method="post" enctype="multipart/form-data">
						...
						<div class="get-buttons">
							<a class="btn btn-dark float-left" type="button" href="/controller/adminPage/adminFreeBoard/remove?id=${freeBoard.board_id}">글삭제</a>
							<div class="float-right">
								<button class="btn btn-dark" type="button" onclick="location.href='${pageContext.request.contextPath}/adminPage/adminFreeBoard/list'">목록</button>
							</div>
						</div>
					</form>
				</div>
